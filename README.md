...
1. **Hardcoded Engine vs. AI Agent**: The core audit engine uses deterministic, hardcoded rules written in Python instead of an LLM. This guarantees 100% accurate mathematical calculations and prevents hallucinations when dealing with financial data.
